export const EXPERIENCE = [
  {
    id: 'EXP-01',
    role: 'Chief Interface Architect',
    ...
    highlights: [
      ...
      'Authored fleet deployment CLIs to manage subspace redirects during mass migration events.',
      'Designed unified telemetry buses (Adobe/Tealium) for tracking signals across the quadrant.',
      'Commanded technical simulations to onboard new engineering cadets across three global starbases.'
    ]
  },
  {
    id: 'EXP-02',
    role: 'Lead Planetary Engineer',
  ...
  {
    id: 'EXP-03',
    role: 'Full Stack Operations Engineer',
    ...
    highlights: [
      ...
      'Eliminated transaction drift in acquisition protocols, smoothing the checkout flow for all species.'
    ]
  },
  {
    id: 'EXP-04',
    ...
    highlights: [
      ...
      'Optimized navigational beacons (SEO) to improve visibility across Google Assistant and Alexa subroutines.'
    ]
  },
  {
    id: 'EXP-05',
    role: 'Interface Specialist (Contract)',
  ...
  {
    id: 'EXP-06',
    role: 'Medical Systems Architect',
    ...
    highlights: [
      ...
      'Integrated HL7-compliant subspace gateways for secured clinical transmissions.'
    ]
  },
  {
    id: 'EXP-07',
    role: 'Primary Systems Developer',
    ...
    highlights: [
      ...
      'Maintained Exchange-class comm nodes and quantum-telecom relays for the entire sector.'
    ]
  }
]
